                ...
                .setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                    int which) {
                                final String number = numberEdit.getText()
                                        .toString();
                                if (number.isEmpty()) {
                                    log("insert number return");
                                    return;
                                }
                                String phoneNumber = BlacklistUtils
                                        .removeSpeicalChars(number);
                                log("[InputDialog] insert number:"
                                        + phoneNumber);

                                dialog.dismiss();
                                BlacklistUtils.insertNumber(getActivity()
