...
public class BlacklistAddAdapter extends BaseAdapter {
    ...
    private int [] title_arr = new int[]{R.string.choose_from_contacts,R.string.choose_from_recent_call_logs,R.string.enter_a_number};

    BlacklistAddAdapter(Context context, int resId)
    {
        mContext = context;
        mResId = resId;
    }
