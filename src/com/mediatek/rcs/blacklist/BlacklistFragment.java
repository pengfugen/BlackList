...
public class BlacklistFragment extends ListFragment
    ...
    BlacklistUtils.SyncWithContactsCallback, BlacklistAddFragment.InputAction,BlacklistInputDialog.InputAction {
    ...
    private static final String ACTION_ACCESS_RECENT_CALL_LOG = "wind.intent.action.ACCESS_RECENT_CALL_LOG";
    ...
    private static final int REQUEST_CODE_RECENT_CALL = 101;
    ...
    private static final int MSG_ID_ADD_RECENT_CALL_LOG = 101;
    ...
    private BlacklistAddFragment mAddFragment = new BlacklistAddFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAddFragment.setInputAction(this);
    ...
    public void onDestroy() {
        ...
        mAddFragment.setInputAction(null);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if(requestCode == REQUEST_CODE_RECENT_CALL)
        {
            mResultIntent = data;
            mAddTask = new AddMembersTask();
            log("import from call logs start");
            if (mAddTask.getStatus() != AsyncTask.Status.RUNNING) {
                mAddTask.execute(requestCode, resultCode);
            }
        }
    ...
    private class AddMembersTask extends AsyncTask<Integer, String, Integer> {
        ...
        protected Integer doInBackground(Integer... params) {
            log("doInBackground params:"+params[0]);
            if (REQUEST_CODE == params[0]) {
                final long[] contactsId = mResultIntent
                        .getLongArrayExtra(CONTACTS_ADD_ACTION_DATA_RESULT);
                BlacklistUtils.importFromContacts(getActivity()
                        .getContentResolver(), contactsId);

            } else if (REQUEST_CODE_RECENT_CALL == params[0]) {
                HashMap<String,String> map = (HashMap<String, String>) mResultIntent.getSerializableExtra("selected_group_call_info");
                BlacklistUtils.importFromCallLogs(getActivity()
                        .getContentResolver(), map);
            }
            return null;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msg.what) {
                case MSG_ID_IMPORT_CONTACTS:
                    ...
                    break;
                case MSG_ID_ADD_RECENT_CALL_LOG:
                    Intent intent1 = new Intent(ACTION_ACCESS_RECENT_CALL_LOG);
                    try {
                        startActivityForResult(intent1, REQUEST_CODE_RECENT_CALL);
                    } catch (ActivityNotFoundException e) {
                        log("start activity exception");
                        e.printStackTrace();
                    }
    ...
    @Override
    public void onClickInputNumberBtn() {
        showInputDialog();
    }
    ...
    @Override
    public void onClickCallLogBtn() {
        log("onClickCallLogBtn");
        mMsgHandler.sendEmptyMessage(MSG_ID_ADD_RECENT_CALL_LOG);
    }
